 ...
 * @private
 */
export declare const StopCommandName = "STOP";
/**
 ...
 */
export type ActionHandler<TState extends TurnState = TurnState, TData = any> = (context: TurnContext, state: TState, data: TData, action?: string) => Promise<string>;
/**
 * @private
 */
