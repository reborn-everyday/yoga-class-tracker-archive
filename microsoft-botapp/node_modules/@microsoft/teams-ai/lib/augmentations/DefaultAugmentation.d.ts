 ...
 */
export declare class DefaultAugmentation implements Augmentation<string> {
    /**
     ...
     */
    validateResponse(context: TurnContext, memory: Memory, tokenizer: Tokenizer, response: PromptResponse<string>, remaining_attempts: number): Promise<Validation<string>>;
    /**
     ...
     */
    createPlanFromResponse(context: TurnContext, memory: Memory, response: PromptResponse<string>): Promise<Plan>;
}
//# sourceMappingURL=DefaultAugmentation.d.ts.map