...
exports.JSONResponseValidator = void 0;
...
class JSONResponseValidator {
     ...
     */
    constructor(schema, missingJsonFeedback, errorFeedback) {
        this.schema = schema;
    ...
    validateResponse(context, memory, tokenizer, response, remaining_attempts) {
        ...
        const parsed = Response_1.Response.parseAllObjects(text);
        if (parsed.length == 0) {
        ...
        if (this.schema) {
            ...
            for (let i = parsed.length - 1; i >= 0; i--) {
                const obj = Response_1.Response.removeEmptyValuesFromObject(parsed[i]);
...
exports.JSONResponseValidator = JSONResponseValidator;
//# sourceMappingURL=JSONResponseValidator.js.map