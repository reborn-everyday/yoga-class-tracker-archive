import { ICommandResultActivity } from './command-result.mjs';
export { CommandResultValue } from './command-result.mjs';
import { ICommandSendActivity } from './command-send.mjs';
export { CommandValue } from './command-send.mjs';
import '../activity.mjs';
...
type CommandActivity<T = any> = ICommandSendActivity<T> | ICommandResultActivity<T>;

export { type CommandActivity, ICommandResultActivity, ICommandSendActivity };
