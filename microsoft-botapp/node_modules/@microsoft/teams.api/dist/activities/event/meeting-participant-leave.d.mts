import { TeamsChannelAccount } from '../../models/account.mjs';
...
interface IMeetingParticipantLeaveEventActivity extends IActivity<'event'> {
    /**
...
export type { IMeetingParticipantLeaveEventActivity };
