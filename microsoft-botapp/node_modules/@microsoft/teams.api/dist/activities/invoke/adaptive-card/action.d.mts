...
import { AdaptiveCardInvokeValue } from '../../../models/adaptive-card/adaptive-card-invoke-value.mjs';
...
interface IAdaptiveCardActionInvokeActivity extends IActivity<'invoke'> {
    /**
...
export type { IAdaptiveCardActionInvokeActivity };
