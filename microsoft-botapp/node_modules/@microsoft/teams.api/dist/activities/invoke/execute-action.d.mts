...
import { O365ConnectorCardActionQuery } from '../../models/o365/o365-connector-card-action-query.mjs';
...
interface IExecuteActionInvokeActivity extends IActivity<'invoke'> {
    /**
...
export type { IExecuteActionInvokeActivity };
