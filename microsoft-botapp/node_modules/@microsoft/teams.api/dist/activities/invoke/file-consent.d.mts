...
import { FileConsentCardResponse } from '../../models/file/file-consent-card.mjs';
...
interface IFileConsentInvokeActivity extends IActivity<'invoke'> {
    /**
...
export type { IFileConsentInvokeActivity };
