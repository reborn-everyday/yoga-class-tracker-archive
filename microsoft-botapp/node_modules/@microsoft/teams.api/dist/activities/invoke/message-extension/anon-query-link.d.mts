...
import { AppBasedLinkQuery } from '../../../models/app-based-link-query.mjs';
...
interface IMessageExtensionAnonQueryLinkInvokeActivity extends IActivity<'invoke'> {
    /**
...
export type { IMessageExtensionAnonQueryLinkInvokeActivity };
