import { SignInFailure } from '../../../models/sign-in/sign-in-failure.mjs';
 ...
 */
interface ISignInFailureInvokeActivity extends IActivity<'invoke'> {
    /**
...
export type { ISignInFailureInvokeActivity };
