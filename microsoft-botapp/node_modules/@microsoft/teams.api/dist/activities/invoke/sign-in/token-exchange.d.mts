import { SignInExchangeToken } from '../../../models/sign-in/sign-in-exchange-token.mjs';
...
interface ISignInTokenExchangeInvokeActivity extends IActivity<'invoke'> {
    /**
...
export type { ISignInTokenExchangeInvokeActivity };
