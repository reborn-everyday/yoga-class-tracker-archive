import { SigninStateVerifyQuery } from '../../../models/sign-in/sign-in-state-verify-query.mjs';
...
interface ISignInVerifyStateInvokeActivity extends IActivity<'invoke'> {
    /**
...
export type { ISignInVerifyStateInvokeActivity };
